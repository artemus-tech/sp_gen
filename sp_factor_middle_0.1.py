...
sp_eval_avg_100 =dbassets.get_data_by_id(table_name="sp_eval_avg",column_name="row_id",record_id=6) ##dbassets.get_data_by_id()
sp_eval_avg_50 = dbassets.get_data_by_id(table_name="sp_eval_avg",column_name="row_id",record_id=5) #os.path.join(const.path_avg,"sp_avg_eval_[849_948].txt")
sp_eval_avg_30 =dbassets.get_data_by_id(table_name="sp_eval_avg",column_name="row_id",record_id=4) #os.path.join(const.path_avg,"sp_avg_eval_[1978_2067].txt")

sp_intens_sum_norm_avg_100 =dbassets.get_data_by_id(table_name="sp_intens_sum_norm_avg",column_name="row_id",record_id=6) ##dbassets.get_data_by_id()
sp_intens_sum_norm_avg_50 =dbassets.get_data_by_id(table_name="sp_intens_sum_norm_avg",column_name="row_id",record_id=5) #os.path.join(const.path_avg,"sp_avg_eval_[849_948].txt")
sp_intens_sum_norm_avg_30 =dbassets.get_data_by_id(table_name="sp_intens_sum_norm_avg",column_name="row_id",record_id=4) #os.path.join(const.path_avg,"sp_avg_eval_[1978_2067].txt")
